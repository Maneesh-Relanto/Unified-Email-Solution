...
export function SecurityOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center cursor-pointer backdrop-blur-sm" onClick={toggleSecurityMode}>
      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm mb-4">Content is hidden from view</p>
